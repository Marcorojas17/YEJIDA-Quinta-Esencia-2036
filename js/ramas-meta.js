...
const RAMAS_META = {
  AA: {
    titulo: 'Riesgos y Amenazas',
    heb: 'סיכונים',
    icono: '⚠️',
    color: '#e74c3c',
    desc: 'Qué puede fallar y cómo responder.',
    sub: {
  ...
  AB: {
    ...
    icono: '🎯',
    color: '#3498db',
    desc: 'Aplicaciones concretas del sistema.',
    sub: {
  ...
  AC: {
    ...
    icono: '🔗',
    color: '#9b59b6',
    desc: 'Conexión con el Acta Fundacional.',
    sub: {
  ...
  AE: {
    titulo: 'Roadmap 10 Años',
    heb: 'מפת דרכים',
    icono: '🗺️',
    color: '#1abc9c',
    desc: 'Visión a largo plazo.',
    sub: {
  ...
  AF: {
    titulo: 'Fundación y Legado',
    heb: 'מורשת',
    icono: '🏛️',
    color: '#8e44ad',
    desc: 'Qué queda cuando ya no estés.',
    sub: {
  ...
  AG: {
    titulo: 'Testigos Descentralizados',
    heb: 'עדים',
    icono: '👁️',
    color: '#e67e22',
    desc: 'Oráculos humanos y máquinas.',
    sub: {
  ...
  AH: {
    titulo: 'Pruebas de Humanidad',
    heb: 'הוכחת אנושיות',
    icono: '🧑',
    color: '#16a085',
    desc: 'Anti-bot, anti-IA, Proof of Personhood.',
    sub: {
  ...
  AI: {
    titulo: 'Verificación de Contenido IA',
    heb: 'אימות תוכן',
    icono: '🤖',
    color: '#c0392b',
    desc: 'Cómo distinguir IA de humano.',
    sub: {
  ...
  AJ: {
    titulo: 'Seguros Descentralizados',
    heb: 'ביטוח',
    icono: '🛡️',
    color: '#27ae60',
    desc: 'Cobertura ante fallos.',
    sub: {
  ...
  AK: {
    titulo: 'Reputación Portable',
    heb: 'מוניטין',
    icono: '⭐',
    color: '#f1c40f',
    desc: 'Llevar tu historial entre plataformas.',
    sub: {
  ...
  AL: {
    titulo: 'Privacidad Diferencial',
    heb: 'פרטיות',
    icono: '🔒',
    color: '#2980b9',
    desc: 'Datos agregados sin exponer individuos.',
    sub: {
  ...
  AM: {
    titulo: 'Computación Confidencial',
    heb: 'מחשוב חסוי',
    icono: '🔐',
    color: '#8e44ad',
    desc: 'Cálculo sin exponer datos.',
    sub: {
  ...
  AN: {
    ...
    icono: '🕸️',
    color: '#3498db',
    desc: 'Grafos, ontologías y linked data.',
    sub: {
  ...
  AO: {
    titulo: 'Interfaz Cerebro-Computadora',
    heb: 'ממשק מוח',
    icono: '🧠',
    color: '#e84393',
    desc: 'El futuro, ética y límites.',
    sub: {
